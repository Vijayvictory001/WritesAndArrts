        ...
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <form action="{{route('Register')}}" method="POST">
                    @csrf
                    <h2>Hello, Welcome!</h2>
                    <p class="my-2 text-secondary">Create an account</p>
                    <div class="my-3 ">
                        <input type="text" name="name" placeholder="Enter the username" class="form-control shadow-none"
                            autofocus="true">
                    </div>
                    <div class="my-3 ">
                        <input type="email" name="email" placeholder="Enter the Email" class="form-control shadow-none"
                            autofocus="true">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="checkbox" name="checkbox"><span class="text-secondary"> Remember me</span>
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-success shadow-none w-100">Register</button>
                    </div>
                </form>
            </div>
        </div>
